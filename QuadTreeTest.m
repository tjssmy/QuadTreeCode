...
GetQTSurfaceAndFct(KVAL,1,1,'block k with interp',[]);
...
IntBC(end+1) = QTCirIntBC(30,275,10,[0 8e3 -0000],'m');
...
[~,h] = GetQTSurfaceAndFct(VVAL,1,1,'Solution with interp',[]);
...
IntBC(3).TransMode(2) = 'c';
IntBC(3).valTrans{2} = [8e3]';
IntBC(3).TransMode(3) = 'l';
IntBC(3).valTrans{3} = [0.0,-3,1000]';

figure

SolveQTTransSol(1500,1000,10,IntBC)
